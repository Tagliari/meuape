		...
		<div class="wrapper">
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					<h1>
						<fmt:message key="management.user.page.title" />
					</h1>
					<ol class="breadcrumb">
						<li><a href="#"><i class="fa fa-dashboard"></i>Home</a></li>
						<li class="active"><fmt:message key="management.breadcrumbs.user" /></li>
					</ol>
				</section>
				...
				<section class="content">
					<div class="row">
						...
						<section class="col-lg-12 connectedSortable">
							<jsp:include page="fragments/create_user.jsp"/>
<%-- 							<jsp:include page="fragments/all_users.jsp"/>	 --%>
						</section>
