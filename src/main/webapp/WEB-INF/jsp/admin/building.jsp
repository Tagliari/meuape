			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					...
					<ol class="breadcrumb">
						...
						<li class="active"><fmt:message key="management.breadcrumbs.building" /></li>
					</ol>
				</section>
				...
				<section class="content">
					<div class="row">
						...
						<section class="col-lg-12 connectedSortable">
							<jsp:include page="fragments/create_building.jsp"/>
							<jsp:include page="fragments/all_buildings.jsp"/>	
						</section>
